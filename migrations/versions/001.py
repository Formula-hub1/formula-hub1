...
Revision ID: 001
Revises:
Create Date: 2025-12-07 19:24:03.883601
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("recommended_datasets_json", sa.Text(), nullable=True),
    ...
    op.create_table(
        "dataset_community_submission",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("dataset_id", sa.Integer(), nullable=False),
        sa.Column("community_id", sa.Integer(), nullable=False),
        sa.Column(
            "status", sa.Enum("PENDING", "ACCEPTED", "REJECTED", "WITHDRAWN", name="submissionstatus"), nullable=True
        ),
    ...
    op.create_table(
        "formula_dataset",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("nombre_gp", sa.String(length=200), nullable=False),
        sa.Column("anio_temporada", sa.Integer(), nullable=False),
        sa.Column("fecha_carrera", sa.Date(), nullable=False),
        sa.Column("circuito", sa.String(length=200), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"],
            ["dataset.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("dataset_id", sa.Integer(), nullable=False),
        sa.Column("piloto_nombre", sa.String(length=120), nullable=False),
        sa.Column("equipo", sa.String(length=120), nullable=False),
        sa.Column("motor", sa.String(length=120), nullable=True),
        sa.Column("posicion_final", sa.String(length=20), nullable=False),
        sa.Column("puntos_obtenidos", sa.Float(), nullable=False),
        sa.Column("tiempo_carrera", sa.String(length=50), nullable=True),
        sa.Column("vueltas_completadas", sa.Integer(), nullable=True),
        sa.Column("estado_carrera", sa.String(length=120), nullable=True),
        sa.ForeignKeyConstraint(
            ["dataset_id"],
            ["formula_dataset.id"],
        ),
...
def downgrade():
    ...
    op.drop_table("formula_result")
    op.drop_table("file")
    op.drop_table("uvl_dataset")
    op.drop_table("raw_dataset")
    op.drop_table("formula_dataset")
