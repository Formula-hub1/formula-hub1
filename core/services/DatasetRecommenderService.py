...
class SimilarityCalculator:
    ...
    @staticmethod
    def calculate_final_score(target_ds: DataSet, candidate_ds: DataSet, max_downloads: int, downloads_count: int) -> float:
        ...
        final_score = (WEIGHT_TAGS * score_tags) + \
...
class DatasetRecommenderService:
    ...
    def __init__(self, dataset_repository: DataSetRepository, ds_download_repository: DSDownloadRecordRepository, k: int = 5):
